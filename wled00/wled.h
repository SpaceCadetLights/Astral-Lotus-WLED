...
#define WLED_CODENAME "Lightdrive Astral Lotus"
...
WLED_GLOBAL char apSSID[33] _INIT("Astral Lotus");                             // AP off by default (unless setup)
...
// LED CONFIG
WLED_GLOBAL uint16_t ledCount _INIT(18);          // overcurrent prevented by ABL
...
WLED_GLOBAL char serverDescription[33] _INIT("Astral Lotus");  // Name of module
...
WLED_GLOBAL char alexaInvocationName[33] _INIT("Lotus");          // speech control name of device. Choose something voice-to-text can understand
...
WLED_GLOBAL byte effectPalette _INIT(1);  //default pallete, set to random by isaac
...
WLED_GLOBAL byte presetCycleMin _INIT(1), presetCycleMax _INIT(15);
WLED_GLOBAL uint16_t presetCycleTime _INIT(300);
WLED_GLOBAL unsigned long presetCycledTime _INIT(0);
WLED_GLOBAL byte presetCycCurr _INIT(presetCycleMin);
WLED_GLOBAL bool presetApplyBri _INIT(false); //don't apply brightness to presets (isaac)
